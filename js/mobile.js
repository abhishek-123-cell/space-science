window.onload = function(){
	...
	document.getElementById('mobile-navigation').onclick = function(){
		...
		if(a){
			...
			document.getElementById('mobile-navigation').style.backgroundImage='url(https://media.gettyimages.com/photos/milky-way-over-the-sky-view-from-the-southern-hemisphere-picture-id1155404993?s=2048x2048)';
		} else {
